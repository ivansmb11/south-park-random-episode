...
**Answer:** Vue composable (aligns with Vue 3 Composition API patterns and easier testing)
...
**Answer:** Maintain existing structure with LayoutComponent wrapper (simpler migration, preserves current routing logic)
